...
layui.define(['table', 'form','upload'], function(exports){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{field: 'imgs', title: '图片', width: 100, templet: '#imgTpl'}
      ,{field: 'price', title: '报价', width: 120, sort: true}
      ,{field: 'status', title: '状态',templet: function(d){
        return d.status == 1 ? '<span>上架</span>' : '<span style="color: #c00;">下架</span>';
      },sort: true, width: 80}
